...
func TestLoad(t *testing.T) {
	...
	require.Equal(t, "github.com/go-ent/ent/entc/load/testdata/valid", spec.PkgPath)
...
func TestLoadCycleError(t *testing.T) {
	...
	spec, err := cfg.Load()
	require.Nil(t, spec)
	require.EqualError(t, err, `entc/load: parse schema dir: import cycle not allowed: import stack: [github.com/go-ent/ent/entc/load/testdata/cycle github.com/go-ent/ent/entc/load/testdata/cycle/fakent github.com/go-ent/ent/entc/load/testdata/cycle]
