...
//go:generate go run -mod=mod github.com/go-ent/ent/cmd/ent generate --feature privacy ./schema
```
...
```go
//go:generate go run -mod=mod github.com/go-ent/ent/cmd/ent generate --feature privacy,schema/snapshot ./schema
```
...
import (
	...
	"github.com/go-ent/ent/examples/privacyadmin/ent/privacy"
)
...
import (
	...
	"github.com/go-ent/ent/examples/privacyadmin/ent/privacy"
	"github.com/go-ent/ent/examples/privacyadmin/viewer"
)
