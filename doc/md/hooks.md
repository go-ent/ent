...
the same generated `UserMutation` object. However, all builder types implement the generic <a target="_blank" href="https://pkg.go.dev/github.com/go-ent/ent?tab=doc#Mutation">`ent.Mutation`</a> interface.
...
Hooks are functions that get an <a target="_blank" href="https://pkg.go.dev/github.com/go-ent/ent?tab=doc#Mutator">`ent.Mutator`</a> and return a mutator back.
...
import (
	...
	"github.com/go-ent/ent"
	"github.com/go-ent/ent/schema/mixin"
)
