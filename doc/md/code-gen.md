...
```bash
go get -d github.com/go-ent/ent/cmd/ent
``` 
...
```bash
go run -mod=mod github.com/go-ent/ent/cmd/ent new User Pet
```
...
//go:generate go run -mod=mod github.com/go-ent/ent/cmd/ent generate ./schema
```
...
```console
go run -mod=mod github.com/go-ent/ent/cmd/ent generate --template <dir-path> --template glob="path/to/*.tmpl" ./ent/schema
```
...
```bash
go run -mod=mod github.com/go-ent/ent/cmd/ent describe ./ent/schema
```
